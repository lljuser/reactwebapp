      ...
      <div>
          ...
          <div style={{textAlign: 'center', height: '0.4rem'}}>
              <div style={{margin: '0 auto', width: '3rem'}}>
                  <div style={{float: 'left', margin: '2px 4px 4px 2px', width: '12px', height: '11px', backgroundImage: 'url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAGCAYAAAD37n+BAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAABPSURBVChTY1y3esV/BiDYtX09iGJw8wwE0zAAE/f39QPTTGCSBMCYkRQOtgFmMifLXzC9cfMmMI1uI+k2wPwAA+hu/v6HGUzDxEm0gYEBALKKGjTje4yiAAAAAElFTkSuQmCC)', backgroundRepeat: 'repeat'}} />
                  <div style={{float: 'left', fontSize: '11px', marginTop: '2px'}}>已偿付</div>
                  <div style={{float: 'left', margin: '2px 4px 4px 2px', width: '12px', height: '11px', backgroundColor: '#B7AFA5'}} />
